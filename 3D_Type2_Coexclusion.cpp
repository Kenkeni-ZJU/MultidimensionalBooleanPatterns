...
//========Show List of The Parameters for Execution
	...
	//==================== OUTPUT FILES
    string out_file_name_Type_2_co_exclusion =output_prefix+"_Type_2_co_exclusion_short.txt";
    string out_file_name_Type_2_co_exclusion_long =output_prefix+"_Type_2_co_exclusion_long.txt";

	Three_D_Patterns_Pipelines::find_3D_Type_2_co_exclusion_Patterns_for_each_Score_and_Presence_Threshold(&OTU_file_name[0], 
		&out_file_name_Type_2_co_exclusion[0], &out_file_name_Type_2_co_exclusion_long[0],
