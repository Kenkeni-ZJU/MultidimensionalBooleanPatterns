...
//3d_Switch_Pattern: define this pattern
...
//========Parsing"<< input parameters"<<
    for (unsigned int argn= 1; argn < argc-1 ; argn++) 
    {
        ...
        default:
           cout<<"Parameter that you entered: -"<<argv[argn]<<" was not recognized!" <<endl;
            exit(EXIT_FAILURE);
        }
    }
...
//========Show List of The Parameters for Execution
    ...
    cout<<"Presebce threshold step: "<< threshold_presence_step<<endl;
...
//==================== OUTPUT FILES
    string out_file_X23_copresent_if_X1_present =output_prefix+"_X23_copresent_if_X1_present_short.txt";
    string out_file_name_One_way_X23_copresent_if_X1_present_long =output_prefix+"_X23_copresent_if_X1_present_long.txt";


	Three_D_Patterns_Pipelines::find_3D_Pattern_X23_copresent_if_X1_present_and_co_exclude_if_X1_absent_for_each_Score_and_Presence_Threshold(&OTU_file_name[0], 
		&out_file_X23_copresent_if_X1_present[0], &out_file_name_One_way_X23_copresent_if_X1_present_long[0],
