...
//========Show List of The Parameters for Execution
    cout<<"Pickle performs search for two dimensional patterns using following the parameters:"<<endl;
...
//Pipelines
    ...
    string out_file_name_co_presence =output_prefix;
    out_file_name_co_presence=out_file_name_co_presence+"_co_presence_short.txt";
    string out_file_name_co_presence_long =output_prefix;
    out_file_name_co_presence_long=out_file_name_co_presence_long+"_co_presence_long.txt";

//Co-Presence
	Two_D_Patterns_Pipelines::find_2D_Co_Presence_patterns(&OTU_file_name[0], &out_file_name_co_presence[0], &out_file_name_co_presence_long[0],
...
//Co-Exclusion
    ...
    string out_file_name_co_exclusion = output_prefix;
    out_file_name_co_exclusion =out_file_name_co_exclusion +"_co_exclusion_short.txt";
    string out_file_name_co_exclusion_long = output_prefix;
    out_file_name_co_exclusion_long= out_file_name_co_exclusion_long +"_co_exclusion_long.txt";

	Two_D_Patterns_Pipelines::find_2D_Co_Exclusion_patterns(&OTU_file_name[0], &out_file_name_co_exclusion[0], &out_file_name_co_exclusion_long[0],
														min_presence_threshold, max_presence_threshold, threshold_presence_step,
														min_population_threshold, max_population_threshold, population_threshold_step,
														min_score, max_score, score_step);

//One-way relationship
    string out_file_name_One_way = output_prefix;
    out_file_name_One_way =out_file_name_One_way +"_one_way_short.txt";
    string out_file_name_One_way_long = output_prefix;
    out_file_name_One_way_long =out_file_name_One_way_long+"_one_way_long.txt";

	Two_D_Patterns_Pipelines::find_2D_One_Way_Relation_patterns(&OTU_file_name[0], &out_file_name_One_way[0], &out_file_name_One_way_long[0],
																min_presence_threshold, max_presence_threshold, threshold_presence_step,
																min_population_threshold, max_population_threshold, population_threshold_step,
																min_score, max_score, score_step);
